...
describe('Component Tests', () => {
  describe('Expend Management Component', () => {
    let comp: ExpendComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExpendComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.expends?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
